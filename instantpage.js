...
const _locationOrigin = location.origin // Caching location.origin to avoid repeated property access in the hot path
...
function isPreloadable(anchorElement) {
  ...
  // Using hasAttribute instead of dataset for performance (approx. 60x faster in benchmarks)
