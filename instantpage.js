...
function init() {
  // Caching location properties to avoid repeated property lookups in hot paths
...
function isPreloadable(anchorElement) {
  ...
  // Using .hasAttribute() instead of .dataset for performance (avoids DOMStringMap overhead)
