...
let _chromiumMajorVersionInUserAgent = null
  ...
  // Cache static location properties to avoid repeated lookups in the hot path
...
function isPreloadable(anchorElement) {
  ...
  // Use hasAttribute because accessing dataset is slower (requires DOMStringMap proxy)
