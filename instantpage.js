...
const _locationOrigin = location.origin // Cache origin to avoid repeated access in isPreloadable
const _locationProtocol = location.protocol // Cache protocol to avoid repeated access in isPreloadable
